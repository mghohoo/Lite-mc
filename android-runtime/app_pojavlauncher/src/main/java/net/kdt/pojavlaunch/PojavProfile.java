...
public class PojavProfile {
    ...
    public static MinecraftAccount getCurrentProfileContent(@NonNull Context ctx, @Nullable String profileName) {
        String selected = profileName == null ? getCurrentProfileName(ctx) : profileName;
        if (com.litemc.launcher.LiteRuntimeAccount.PROFILE.equals(selected))
            return com.litemc.launcher.LiteRuntimeAccount.read(ctx);
