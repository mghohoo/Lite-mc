...
public class JREUtils {
    ...
    public static void setJavaEnvironment(Activity activity, String jreHome) throws Throwable {
        ...
        // Lite-MC does not accept environment overrides from its externally writable game directory.
        if (!com.litemc.launcher.LiteRuntimeAccount.PROFILE.equals(net.kdt.pojavlaunch.PojavProfile.getCurrentProfileName(activity)))
