...
public class LauncherPreferences {
    ...
    public static void loadPreferences(Context ctx) {
        ...
        // VSync adds a frame of latency and caps FPS to the display refresh rate.
        // Users can still enable it in video settings, but the launcher defaults to
        // the low-latency path so first launch does not inherit a hidden FPS cap.
